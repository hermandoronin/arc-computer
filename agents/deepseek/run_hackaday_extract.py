...
# Config
RAW_DIR = Path("/home/user/aisurvive/kb/output/raw/hackaday")
...
FAILED_LOG = Path("/home/user/aisurvive/kb/output/extracted-bulk/validation-reports/hackaday-failures.jsonl")
